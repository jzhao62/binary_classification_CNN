...
# test-train split
X, X_test, Y, Y_test = train_test_split(allX, ally, test_size=0.3, random_state=42)
...
###################################
model.fit(X, Y, validation_set=(X_test, Y_test), batch_size=5, n_epoch=10, run_id='model_cat_dog_6', show_metric=True)
